subroutine one_element2(a1,b1,a2,b2,val,S,H,EE,n_bas)
...
! Computing norm square of phi_11(i)
 ...
 do i=1,6
  ...
  norm_aa1=norm_aa1+a1(i,1)*a1(k,1)*nm*3.d0/4.d0
  end do
 end do
...
! Computing norm square of phi_12(i)
 ...
 do i=1,4
  do k=1,4
   ...
   norm_bb1=norm_bb1+b1(i,1)*b1(k,1)*nm*9.d0/4.d0
  end do 
 end do 
...
! Computing norm square of phi_12(j)
 ...
 do i=1,4
  ...
  norm_bb2=norm_bb2+b2(i,1)*b2(k,1)*nm*9.d0/4.d0
  end do
 end do
...
val2=0;
  do i=1,4
   do j=1,4
       ...
       val2=val2+b1(i,1)*b2(j,1)*v*9.d0/4.d0
   end do
 end do
